...
async function editAndSendImage(message, image){
    let img = `./assets/gmedits/test/invert${message.author.id}.jpg`;
...
module.exports.run = async (bot, message, args) => {
    ...
    let image = "";
    let help = `Usage: ${bot.prefix}invert | to invert colors on the last picture sent in chat\n${bot.prefix}invert me | to invert your avatar colors\n${bot.prefix}invert @name | to invert someone's avatar colors`
