...
module.exports.run = async (bot, message, args) => {
    ...
    let help = `Usage: ${bot.prefix}ghandhi <text> | to make Ghandhi say a quote\n${bot.prefix}ghandhi <text>;<name> | to make Ghandhi say a quote but change the name\n`
    ...
    // Get image
    let img = `./assets/gmedits/test/ghandhi${message.author.id}.jpg`;
    let image = `./assets/images/Ghandhi.jpg`;
    // Image configuration
